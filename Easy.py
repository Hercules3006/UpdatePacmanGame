...
def checkGhostCollisionFrighten():
    global score, gameOver, level, k_up, k_down, k_left, k_right, entities, ghosts, wall, blinkGhost, clydeGhost, pacman, timerStart
...
def init():
    global level, pacman, blinkGhost, clydeGhost, ghosts, wall, totalFood
...
def main():
    global score, gameOver, level, k_up, k_down, k_left, k_right, entities, ghosts, wall, blinkGhost, clydeGhost, pacman, timerStart, win
